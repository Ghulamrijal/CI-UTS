                                    ...
                                    <?php foreach($pegawai as $u){ ?>
                                        <form action="<?php echo base_url();?>pegawai/edit" method="post" class="form-horizontal" >
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-sm-6">
                                                    <input type="text" id="input-normal" name="alamat" placeholder="Normal" class="form-control" value="<?php echo $u->alamat ?>">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-sm-5">
                                                    ...
                                                    <div class="col col-sm-6">
                                                        <input type="text" id="input-normal" name="jabatan" placeholder="Normal" class="form-control"  value="<?php echo $u->jabatan ?>">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-sm-6">
                                                    <input type="text" id="input-normal" name="email" placeholder="Normal" class="form-control"  value="<?php echo $u->email ?>">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-sm-5">
                                                ...
                                                <div class="col col-sm-6">
                                                    <input type="text" id="input-normal" name="umur" placeholder="Normal" class="form-control"  value="<?php echo $u->umur ?>">
                                                </div>
                                            </div>
