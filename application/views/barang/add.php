                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="<?php echo base_url();?>barang/tambah" method="post" class="form-horizontal" >
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <select name="idpegawai">
                                                    ...
                                                    foreach($pegawai as $p) { ?>
                                                                <option value="<?php echo $p->idpegawai; ?>"><?php echo $p->nama; ?></option>
                                                                <?php } ?> 
                                                                </select>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-sm-6">
                                                    <input type="text" id="input-normal" name="nama_brg"  class="form-control" >
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-sm-5">
                                                    ...
                                                    <div class="col col-sm-6">
                                                        <input type="text" id="input-normal" name="spesifikasi" class="form-control" >
